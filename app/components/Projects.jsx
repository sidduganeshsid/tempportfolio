import { assets, projectsData } from "@/assets/assets/assets";
    ...
    <div id="projects" className="w-full px-[12%] py-10 scroll-mt-20">
      ...
      <div className="grid grid-cols-auto gap-6 my-10">
        {projectsData.map(({ icon, title, description, link }, index) => (
          <div
            key={index}
            className="border border-gray-400 rounded-lg px-8 py-12 hover:shadow-black cursor-pointer hover:bg-lightHover hover:-translate-y-3 duration-500"
          >
